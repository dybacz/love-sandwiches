...
def get_sales_data():
    """
    Get the sales figure input from the user.
...
def update_worksheet(data, worksheet):
    """
    Recieves a list of integers ready to be inserted into a worksheet
    Update the relevant worksheet, add a new row to that worksheet
    with the data provided.
    """
    print(f"Updating {worksheet} worksheet...\n")
    worksheet_to_update = SHEET.worksheet((worksheet))
    worksheet_to_update.append_row(data)
    worksheet = worksheet.capitalize()
...
def get_last_5_entries_sales():
    ...
    for each sandwhich and returns the data as a list of lists
    """
